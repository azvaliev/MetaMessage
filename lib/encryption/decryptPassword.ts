...
const decryptPassword = async (password: string) => {
	...
	// iv will either return false or the proper string, depending on if target browser supports IndexedDB
	...
	// Convert JSON parsed object "keypair" into Solana Keypair Class Instance
